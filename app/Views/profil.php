...
<div class="container">
    <h2>Profil Sekolah <?= $sekolah['nama']; ?></h2>
    <?php if ($galeris != null) : ?>
        <hr>
    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="mt-3 col-auto">
                <a href="/profil/ubah" class="btn btn-primary">Perbarui Profil</a>
            </div>
        </div>
        <div class="col-6">
            <p> NPSN Sekolah :<br><?= $sekolah['id']; ?></p>
            <p> Alamat Sekolah :<br><?= $sekolah['alamat']; ?></p>
            <p> Kepala Sekolah :<br><?= $sekolah['kepsek']; ?></p>
            <p> Email Sekolah :<br><?= $sekolah['email']; ?></p>
            <p> No. Telepon Sekolah :<br><?= $sekolah['nohp']; ?></p>
        </div>
    </div>
</div>
